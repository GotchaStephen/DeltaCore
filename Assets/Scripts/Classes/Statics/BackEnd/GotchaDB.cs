    ...
    ";
        ...
        */
        ...
        public DataTable GetLOTDSamplesForUser(int pId)
        {
            ...
            SQLStatement = SQLStatement.Replace(":SMPL_LOTD_COMPL_TBL_SCORE", GotchaConstants.SMPL_LOTD_COMPL_TBL_SCORE);
        ...
        /*
        public int AddAppliedFeatureForSolutionLOTD(int sampleID, ConsensusScoreObject cso)
        {
            string SQLStatement = @"
        ...
        */
        ...
        public bool updateLotdScoreForUser(int sampleId, int userID, float score)
        {
            string SQLStatement = @"
                UPDATE  :SMPL_LOTD_COMPL_TBL_NAME
                SET     :SMPL_LOTD_COMPL_TBL_SCORE = {2}
                WHERE   
                    :SMPL_LOTD_COMPL_TBL_SAMPLE_ID = {0} 
                    AND :SMPL_LOTD_COMPL_TBL_USR_ID = {1} 
                ";
            ...
            SQLStatement = SQLStatement.Replace(":SMPL_LOTD_COMPL_TBL_SAMPLE_ID", GotchaConstants.SMPL_LOTD_COMPL_TBL_SAMPLE_ID);
            SQLStatement = SQLStatement.Replace(":SMPL_LOTD_COMPL_TBL_USR_ID", GotchaConstants.SMPL_LOTD_COMPL_TBL_USR_ID);
            SQLStatement = string.Format(SQLStatement, sampleId, userID, score);
            localLog(SQLStatement);
            g.Modify(SQLStatement);
            return true;
        }
