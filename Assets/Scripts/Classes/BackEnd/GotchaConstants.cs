...
namespace DeltaCoreBE
{
	...
	public static class GotchaConstants
	{
		...
		public const string SMPL_LOTD_COMPL_TBL_I_COST = "insert_cost";
		public const string SMPL_LOTD_COMPL_TBL_S_COST = "substitute_cost";
		public const string SMPL_LOTD_COMPL_TBL_D_COST = "delete_cost";
